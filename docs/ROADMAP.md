...
- [ ] **Русский язык интерфейса.** Сейчас en/pt/es/de/fr в
  `apps/device-center/src/I18nManager.cpp`. Добавить `ru` (~80 строк) и
  проверить, что длинные русские строки не ломают вёрстку чипов и кнопок.
