...
| **WH-1000XM4** | V1 | RFCOMM | Verified | Verified | Verified | Verified | Expected (awaiting dump) | Verified | AAC verified | Verified (on/off; Standard ~30s) | Expected (awaiting dump) | 3.0.1 | Community (Windows) |
